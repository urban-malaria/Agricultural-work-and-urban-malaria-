...
# log in into dhs
my_config <- set_rdhs_config(email = "ozodiegwui@gmail.com", #cchiziba@gmail.com",#"ozodiegwui@gmail.com",
...
write_csv(urban_df, file.path(PopDir, "analysis_dat/251106_urban_df_for_analysis_trend.csv"))
...
write_csv(rural_df, file.path(PopDir, "analysis_dat/251106_rural_df_for_analysis_trend.csv"))
